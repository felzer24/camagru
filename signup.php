...
try{
    ...
    if(isset($_POST['submit'])){
        ...
        if (strlen($pass) < 6 || strlen($pass) > 12 || !preg_match("#[A-Z]+#", $pass))
        {
            ...
            header('Refresh: 5; URL=http://localhost:8080/camagru/login.phtml');
        }
        ...
        values(:username,:email,:password,:code)");
            ...
            $insert->execute();
            $str = "your verification link is http://localhost:8080/camagru/confirmation.php?user=".$email."&code=".$code;
